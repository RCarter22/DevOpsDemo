 ...
 * All rights reserved.
 ******************************************************************************/
package com.interprosoft.ezmaxmobile.wpmaterial.action;
...
@Component
@Scope("prototype")
@Namespace("/wpmaterial")
@ResultPath(value="/")
@ParentPackage(value="mydefault")
@Results({@Result(name="error", location="/error/error.jsp")})
public class WPMaterialAction extends BaseAction {
	
	private static final long serialVersionUID = 1L;

	public static final String OWNERMBO = "WPMATERIAL";
	...
	public String execute() {
		try {
			...
			populateMboListByRelationship(currentMbo, "SHOWPLANMATERIAL");
		} catch (Exception e){
	...
	@Action(value="view",
			results={
				@Result(name="success", location="wpmaterial.jsp"),
				@Result(name="error", location="wpmaterial.jsp")
			}
		)
	public String view() {
		try{
