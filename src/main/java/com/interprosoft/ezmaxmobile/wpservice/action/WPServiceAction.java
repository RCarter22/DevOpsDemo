 ...
 * All rights reserved.
 ******************************************************************************/
package com.interprosoft.ezmaxmobile.wpservice.action;
...
public class WPServiceAction extends BaseAction {
	
	private static final long serialVersionUID = 1L;

	public static final String OWNERMBO = "WPSERVICE";
	...
	public String execute() {
		try {
			...
			populateMboListByRelationship(currentMbo, "SHOWPLANSERVICE");
		} catch (Exception e){
	...
	@Action(value="view",
			results={
				@Result(name="success", location="wpservice.jsp"),
				@Result(name="error", location="wpservice.jsp")
			}
		)
	public String view() {
		try{
