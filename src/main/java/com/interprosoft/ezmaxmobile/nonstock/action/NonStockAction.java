 ...
 * All rights reserved.
 ******************************************************************************/
package com.interprosoft.ezmaxmobile.nonstock.action;
...
public class NonStockAction extends BaseAction {
	
	private static final long serialVersionUID = 1L;

	public static final String OWNERMBO = "REP_ACTSERV";
	...
	public String execute() {
		try {
			...
			populateMboListByRelationship(currentMbo, "REP_ACTSERV");
	...
	@Action(value="view",
			results={
				@Result(name="success", location="nonstock.jsp"),
				@Result(name="error", location="nonstock.jsp")
			}
		)
	public String view() {
		try{
	...
	public String nextLog() {
		try{               
			mbo = (MboRemote)this.getSessionObject("REP_ACTSERV");
