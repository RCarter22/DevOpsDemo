 ...
 * All rights reserved.
 ******************************************************************************/
package com.interprosoft.ezmaxmobile.pluspwo.action;
...
@Component
@Scope("prototype")
@Namespace("/pluspwo/ws")
@ResultPath(value="/")
@ParentPackage(value="mydefault")
@Results({@Result(name="error", location="/error/error.jsp")})
public class PluspWOWebService  extends BaseAction {
			...
			if (xmin != null && xmax != null && ymin != null && ymax != null){
				...
				if (mboSetRemote != null){
					...
					SelectQuery sql = new SelectQuery()
						.column("WORKORDERID, WONUM, DESCRIPTION, WORKTYPE, WOPRIORITY, LOCATION, ASSETNUM, STATUS, X, Y")
						.from("WORKORDER")
						.where(where);
