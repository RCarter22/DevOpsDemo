...
public class PluspWOAction  extends BaseAction {

	private static final long serialVersionUID = 1L;
	
	public static final String APPNAME = "PLUSPWO";	
	...
	public String push() {
		try{	
			...
			try{
				...
				pushUtil.setOpenLink("pluspwo/view.action?id="+mbo.getUniqueIDValue());
