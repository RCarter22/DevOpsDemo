...
public class InventorAction extends BaseAction {
	...
	public String physicalCount() {
		try{
			mboList = (ArrayList)this.getSessionObject(EMMConstants.CURRENTMBOLIST);
			mboInvbList = (ArrayList)this.getSessionObject("INVBALANCESLIST");
    ...
    public String reconcileBalances() {
	     try{
	            populateMbo(OWNERMBO,APPNAME);                  
	            InventoryRemote invRemote = (InventoryRemote)this.mbo;
