						...
						<s:iterator value="mboList">
							<li>
								<a href="view.action?id=<s:property value="getUniqueIDValue()" />">
									<p><strong><s:property value="getMboValueInfoStatic('SUBJECT').getTitle()" />: <s:property value="getString('SUBJECT')" /></strong></p>
									...
									<p><s:property value="getMboValueInfoStatic('SENDTO').getTitle()" />: <s:property value="getString('SENDTO')"/></p>
