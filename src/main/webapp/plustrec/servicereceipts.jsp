...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<h3 class="ui-title"><s:text name="ezmaxmobile.plustrec"/></h3>
			<a class="ui-btn-right <s:if test="mbo.toBeSaved() eq true">ui-btn-c</s:if>" onclick="emm.core.save()"><s:text name="global.save"/></a>
		</div>
		<ul class="ui-navbar">
			<li>
				<a href="materialreceipts.action?id=<s:property value="mbo.getUniqueIDValue()"/>">
		...
		<div class="ui-content">
			...
			<ul class="ui-listview">			
				<li class="ui-divider"><s:text name="receipts.servicereceipts"/></li>		
				<li class="ui-field">
			...
			<s:if test="mboList.isEmpty() eq false">
				<div class="ui-section"><s:text name="receipts.servicereceipts"/></div>			
				<ul class="ui-listview">
					...
					<s:iterator value="mboList">
						<li>
							<span>
								...
								<div class="ui-row-4">
									<div class="ui-column">
										<strong><s:property value="getMboValueInfoStatic('QTYTORECEIVE').getTitle()"/></strong>: <s:property value="getString('QTYTORECEIVE')"/>		
									</div>
									<div class="ui-column">
								...
								<div class="ui-row-4">
									...
									<div class="ui-column">
										<strong><s:property value="getMboValueInfoStatic('CURRENCYLINECOST').getTitle()"/></strong>: <s:property value="getString('CURRENCYLINECOST')"/>
									</div>
									<div class="ui-column">
			...
			<s:if test="!mbo.isNew()">
				<s:include value="servicerecactions.jsp"/>
			</s:if>							
		</div>			
	</div>
</body>
