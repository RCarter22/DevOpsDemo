...
<body>
	<div class="ui-page" data-rememberscroll="true">
		...
		<div class="ui-header">
			...
			<h3 class="ui-title"><s:text name="ezmaxmobile.plustitm"/></h3>	
			...
			<s:if test="mboList.size > 0">
				<s:if test="pagination.total > 1">
					<ul class="ui-listview">
						<li class="ui-field ui-sort"><label><s:text
									name="global.sortby" /></label> 
								<select name="pagination.sortBy"onchange="emm.core.changeSortBy()" data-value="<s:property value="pagination.sortBy"/>">
									...
									<option value="STATUSDATE"><s:property value="mboList.get(0).getMboValueInfoStatic('STATUSDATE').getTitle()" /></option>
									<option value="COMMODITYGROUP"><s:property value="mboList.get(0).getMboValueInfoStatic('COMMODITYGROUP').getTitle()" /></option>
					...
					<s:iterator value="mboList">
						<li>
							<a href="view.action?id=<s:property value="getUniqueIDValue()"/>">
								...
								<p><s:property value="getMboValueInfoStatic('COMMODITYGROUP').getTitle()"/>: <s:property value="getString('COMMODITYGROUP')"/></p>
