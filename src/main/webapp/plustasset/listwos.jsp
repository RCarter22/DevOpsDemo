			...
			<s:if test="mboList.size > 0">
				<ul class="ui-listview">			
					...
					<s:iterator value="mboList">
						<li>
							<a href="../plustwo/view.action?id=<s:property value="getUniqueIDValue()"/>">
								...
								<p><s:property value="getMboValueInfoStatic('ACTSTART').getTitle()"/>: <s:property value="getString('ACTSTART')"/></p>								
<%-- 								<p><s:property value="getMboValueInfoStatic('LEAD').getTitle()"/>: <s:property value="getString('LEAD')"/></p> --%>
								...
								<p><s:property value="getMboValueInfoStatic('PLUSTDEFASSETALIAS.ALIAS').getTitle()"/>: <s:property value="getString('PLUSTDEFASSETALIAS.ALIAS')"/></p>								<span class="ui-arrow"></span>
							</a>
						</li>
					</s:iterator>
					<s:include value="../common/pagination.jsp"/>
