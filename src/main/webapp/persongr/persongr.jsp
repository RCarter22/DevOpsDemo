...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<a class="ui-btn-right <s:if test="mboList.get(0).getThisMboSet().toBeSaved() eq true">ui-btn-c</s:if>" onclick="emm.core.save('savepersongroup.action')"><s:text name="global.save"/></a>
