						...
						<s:iterator value="mboList">
							<li>
								<a href="viewmove.action?id=<s:property value="getUniqueIDValue()"/>">
									...
									<p><s:property value="getMboValueInfoStatic('SITEID').getTitle()"/>: <s:property value="getString('SITEID')"/></p>										
...
<!-- 						<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="ASSETNUM" data-source="ASSETNUM" data-display="DESCRIPTION,ASSETNUM,SERIALNUM,LOCATION" data-search="ASSETNUM,LOCATION,SERIALNUM,DESCRIPTION"></a> --> 
					...
					<li class="ui-field">
						<label><s:property value="mbo.getMboValueInfoStatic('NEWPARENT').getTitle()" /></label>
						<input type="text"
								id="NEWPARENT" 
								required="<s:property value="mbo.getMboValueData('NEWPARENT').isRequired()"/>"
								readonly="<s:property value="mbo.getMboValueData('NEWPARENT').isReadOnly()"/>"
								value="<s:property value="mbo.getString('NEWPARENT')"/>"
								onchange="emm.core.setValue(this)"
						/>
						<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="NEWPARENT" data-source="ASSETNUM" data-display="ASSETNUM,LOCATION,DESCRIPTION,SITEID" data-search="ASSETNUM,LOCATION,DESCRIPTION"></a>
					</li>
					<%-- <li class="ui-field">
						<label><s:property value="mbo.getMboValueInfoStatic('TLOAMNEWGLACCOUNT').getTitle()" /></label>
						<input type="text"
								id="TLOAMNEWGLACCOUNT" 
								required="<s:property value="mbo.getMboValueData('TLOAMNEWGLACCOUNT').isRequired()"/>"
								readonly="<s:property value="mbo.getMboValueData('TLOAMNEWGLACCOUNT').isReadOnly()"/>"
								value="<s:property value="mbo.getString('TLOAMNEWGLACCOUNT')"/>"
								onchange="emm.core.setValue(this)"
						/>
						<a class="ui-arrow" onclick="emm.core.glalookup(this)" data-field="TLOAMNEWGLACCOUNT"></a>
					</li>  --%>
					<li class="ui-field">
							<label><s:property value="mbo.getMboValueInfoStatic('NEWLOCATION').getTitle()" /></label>
							<input type="text"
									id="NEWLOCATION" 
									required="<s:property value="mbo.getMboValueData('NEWLOCATION').isRequired()"/>"
									readonly="<s:property value="mbo.getMboValueData('NEWLOCATION').isReadOnly()"/>"
									value="<s:property value="mbo.getString('NEWLOCATION')"/>"
									onchange="emm.core.setValue(this)"
							/>
							<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="NEWLOCATION" data-source="LOCATION" data-display="LOCATION,DESCRIPTION,SITEID" data-search="LOCATION,DESCRIPTION"></a>
					</li>
					<li class="ui-field">
						<label><s:property value="mbo.getMboValueInfoStatic('MOVEMODIFYBINNUM').getTitle()" /></label>
						<input type="text"
								id="MOVEMODIFYBINNUM" 
								required="<s:property value="mbo.getMboValueData('MOVEMODIFYBINNUM').isRequired()"/>"
								readonly="<s:property value="mbo.getMboValueData('MOVEMODIFYBINNUM').isReadOnly()"/>"
								value="<s:property value="mbo.getString('MOVEMODIFYBINNUM')"/>"
								onchange="emm.core.setValue(this)"
						/>
						<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="MOVEMODIFYBINNUM" data-source="BINNUM" data-display="BINNUM,LOTNUM,CONDITIONCODE,CURBAL,ORGID" data-search="BINNUM"></a>
					</li>	
