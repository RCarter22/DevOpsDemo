				...
				<ul class="ui-listview">
					<s:iterator value="mboList">
						<s:if test="getString('CLASSSPEC.ASSETATTRIBUTE.DATATYPE') == 'NUMERIC'">
							<li class="ui-field">
								<label><s:property value="getString('ASSETATTRID')" /> - <s:property value="getString('CLASSSPEC.ASSETATTRIBUTE.DESCRIPTION')" /></label>
								<input type="text"
										...
										onchange="emm.core.setValue(this)"
										data-mbo="ASSETSPECCLASS" 
										data-field="NUMVALUE"
								/>
								<s:if test="getString('CLASSSPEC.DOMAINID') != ''">
									<a class="ui-arrow" onclick="emm.core.lookup(this)" data-mbo="ASSETSPECCLASS" data-mboid="<s:property value="getUniqueIDValue()"/>" data-field="NUMVALUE"></a>
								</s:if>
							</li>
						</s:if>
						<s:elseif test="getString('CLASSSPEC.ASSETATTRIBUTE.DATATYPE') == 'ALN'">
							<li class="ui-field">
								...
								/>
								<s:if test="getString('CLASSSPEC.DOMAINID') != ''">
									<a class="ui-arrow" onclick="emm.core.lookup(this)" data-mbo="ASSETSPECCLASS" data-mboid="<s:property value="getUniqueIDValue()"/>" data-field="ALNVALUE"></a>
								</s:if>
							</li>
						</s:elseif>	
					</s:iterator>
