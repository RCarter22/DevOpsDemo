...
<body>
	<div class="ui-page ui-inset">
		...
		<ul class="ui-navbar" id="inspectionbar">			
			...
			<li><a href="listinproginsp.action"><s:text name="inspection.inprogress"/></a>
			<li><a href="listcompleteinsp.action" class="ui-active"><s:text name="inspection.completed"/></a>			
		</ul>	
