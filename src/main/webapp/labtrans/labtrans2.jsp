...
<body>
	<div class="ui-page ui-inset">
		<div class="ui-header">
			...
			<s:else>
				<a class="ui-btn-left" href="goback2.action"><s:text name="global.back"/></a>
			</s:else>		
			...
			<ul class="ui-listview">
				<li class="ui-field">
					...
					<li class="ui-field">
						...
						<input type="text"
								id="WORKORDER.TASKID"
								required="<s:property value="mbo.getMboValueData('WORKORDER.TASKID').isRequired()"/>"
								readonly="<s:property value="mbo.getMboValueData('WORKORDER.TASKID').isReadOnly()"/>"
								value="<s:property value="mbo.getString('WORKORDER.TASKID')"/>"
								onchange="emm.core.setValue(this)"
						/>
						<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="TASKID" data-source="TASKID" data-display="TASKID,DESCRIPTION" data-search="ACTUALSTASKID,DESCRIPTION"></a>
