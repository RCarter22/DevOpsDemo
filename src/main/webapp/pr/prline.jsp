...
<body>
	<div class="ui-page ui-inset">	
		...
		<div class="ui-header">
			<h3 class="ui-title"><s:text name="pr.prline"/></h3>
		...
		<div class="ui-content">
			<ul class="ui-listview">
				<li class="ui-field">
					<label><s:property value="mbo.getMboValueInfoStatic('PRLINENUM').getTitle()" /></label>
					<input type="text"
							id="PRLINENUM" 
							required="<s:property value="mbo.getMboValueData('PRLINENUM').isRequired()"/>"
							readonly="<s:property value="mbo.getMboValueData('PRLINENUM').isReadOnly()"/>"
							value="<s:property value="mbo.getString('PRLINENUM')"/>"
