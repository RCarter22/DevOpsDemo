	...
	<div class="ui-page ui-inset">
		...
		<div class="ui-content">
			<ul class="ui-listview">
				...
				<li class="ui-field">
					<label><s:property value="mbo.getMboValueInfoStatic('FROMSITEID').getTitle()" /></label>
					<input type="text"
							id="FROMSITEID" 
							required="<s:property value="mbo.getMboValueData('FROMSITEID').isRequired()"/>"
							readonly="<s:property value="mbo.getMboValueData('FROMSITEID').isReadOnly()"/>"
							value="<s:property value="mbo.getString('FROMSITEID')"/>"
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="FROMSITEID" data-source="SITEID" data-display="SITEID,DESCRIPTION" data-search="SITEID,DESCRIPTION"></a>
				</li>	
				<li class="ui-field">
			...
			<div class="ui-btn-container">
				<a class="ui-btn-c" href="deletetransferin.action?id=<s:property value="mbo.getUniqueIDValue()"/>"><s:text name="global.delete"/></a>
			</div>
		</div>
	</div>
</body>
