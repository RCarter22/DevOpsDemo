...
<body>
	<div class="ui-page ui-inset">
		...
		<ul class="ui-navbar">			
			...
			<li><a class="ui-active"><s:text name="invissue.transferout"/></a>
			<li><a href="transferin.action?id=<s:property value="mbo.getUniqueIDValue()"/>"><s:text name="invissue.transferin"/></a>			
		</ul>	
		<div class="ui-content">
			    ...
			    <ul class="ui-listview">
					...
					<s:iterator value="mboList">
						<li data-markdeleted="<s:property value="toBeDeleted()"/>">
							<a href="transferoutdetail.action?id=<s:property value="getUniqueIDValue()"/>">
			...
			<div class="ui-btn-container">
				<a class="ui-btn-a" href="newrow.action?action=transferoutdetail.action"><s:text name="global.newrow"/></a>
			</div>
			<div class="ui-sidebar ui-sidebar-only">
				<ul class="ui-listview ui-inset">
					<li data-visible="">
						<a href="newrow.action?action=transferoutdetail.action">
