...
<body>
	<div class="ui-page ui-inset">
		...
		<ul class="ui-navbar">			
			<li><a href="#" class="ui-active"><s:text name="invissue.issuereturn"/></a>
		...
		<div class="ui-content">
			    ...
			    <ul class="ui-listview">
					...
					<s:iterator value="mboList">
						<li data-markdeleted="<s:property value="toBeDeleted()"/>">
							<a href="issuedetail.action?id=<s:property value="getUniqueIDValue()"/>">
			...
			<div class="ui-btn-container">
				<a class="ui-btn-a" href="newrow.action?action=issuedetail.action"><s:text name="global.newrow"/></a>
			</div>
			<div class="ui-sidebar ui-sidebar-only">
				<ul class="ui-listview ui-inset">
					<li data-visible="">
						<a href="newrow.action?action=issuedetail.action">
