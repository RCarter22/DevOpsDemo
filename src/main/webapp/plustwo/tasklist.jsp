	...
	<div class="ui-page" data-rememberscroll="true">
		...
		<div class="ui-content">
					...
					<s:iterator value="mboList">
						<li>
							<a href="viewtask.action?id=<s:property value="getUniqueIDValue()"/>">
								...
								<p><s:property value="getMboValueInfoStatic('PLUSTCOMP').getTitle()"/>: <s:property value="getString('PLUSTCOMP')"/></p>
								<p><s:property value="getMboValueInfoStatic('PLUSTACCOMP').getTitle()"/>: <s:property value="getString('PLUSTACCOMP')"/></p>
								<p><s:property value="getMboValueInfoStatic('PLUSTREASON').getTitle()"/>: <s:property value="getString('PLUSTREASON')"/></p>									
								<span class="ui-arrow"></span>
							</a>
							<a onclick="completeTask(<s:property value="getUniqueIDValue()"/>);" class="ui-checklistbutton" data-checked="<s:property value='getString("STATUS").equals("WCOMP")'/>"></a>
						</li>
					</s:iterator>
					<s:include value="../common/pagination.jsp"/>
				</s:if>
			...
			<form id="completeTaskForm" action="completetask.action" method="post">
				...
				<input type="hidden" name="newStatus" value="WCOMP"/>
			</form> 
		</div>
	</div>		
</body>
