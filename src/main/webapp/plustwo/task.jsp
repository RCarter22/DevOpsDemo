		...
		<div class="ui-content">
			...
			<ul class="ui-listview">
				...
				<li class="ui-field">
					...
					<input type="text"
							id="TASKID" 
							required="<s:property value="mbo.getOwner().getMboValueData('TASKID').isRequired()"/>"
				...
				<s:if test="!mbo.isNew()">
					<li class="ui-field">
						...
						<s:textfield readonly="true" value="%{mbo.getString('STATUS')}" />
					</li>	
				</s:if>
				<li class="ui-field">
				...
				<li class="ui-field">
					<label><s:property value="mbo.getMboValueInfoStatic('PLUSTACCOMP').getTitle()" /></label>
					<input type="text"
							id="PLUSTACCOMP" 
							required="<s:property value="mbo.getMboValueData('PLUSTACCOMP').isRequired()"/>"
							readonly="<s:property value="mbo.getMboValueData('PLUSTACCOMP').isReadOnly()"/>"
							value="<s:property value="mbo.getString('PLUSTACCOMP')"/>"
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="PLUSTACCOMP" data-source="DESCRIPTION" data-display="DESCRIPTION,VALUE" data-orderby="DESCRIPTION ASC" data-search="DESCRIPTION,VALUE"></a>
				</li>
				<li class="ui-field">
					<label><s:property value="mbo.getMboValueInfoStatic('PLUSTCOMP').getTitle()" /></label>
					<input type="text"
							id="PLUSTCOMP" 
							required="<s:property value="mbo.getMboValueData('PLUSTCOMP').isRequired()"/>"
							readonly="<s:property value="mbo.getMboValueData('PLUSTCOMP').isReadOnly()"/>"
							value="<s:property value="mbo.getString('PLUSTCOMP')"/>"
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="PLUSTCOMP" data-source="DESCRIPTION" data-display="DESCRIPTION,COMPONENT" data-orderby="DESCRIPTION ASC" data-search="DESCRIPTION,COMPONENT"></a>
				</li>
				<li class="ui-field">
					<label><s:property value="mbo.getMboValueInfoStatic('PLUSTREASON').getTitle()" /></label>
					<input type="text"
							id="PLUSTREASON" 
							required="<s:property value="mbo.getMboValueData('PLUSTREASON').isRequired()"/>"
							readonly="<s:property value="mbo.getMboValueData('PLUSTREASON').isReadOnly()"/>"
							value="<s:property value="mbo.getString('PLUSTREASON')"/>"
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="PLUSTREASON" data-source="DESCRIPTION" data-display="DESCRIPTION,VALUE" data-orderby="DESCRIPTION ASC" data-search="DESCRIPTION,VALUE"></a>
				</li>
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							value="<s:property value="mbo.getString('MEASUREDATE')"/>"
							onchange="emm.core.setValue(this)"
					/>
