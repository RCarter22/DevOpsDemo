...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<a class="ui-btn-right <s:if test="mbo.toBeSaved() eq true">ui-btn-c</s:if>" onclick="" href="savehierarchy.action?id=<s:property value='mbo.getUniqueIDValue()'/>"><s:text name="global.save"/></a>
