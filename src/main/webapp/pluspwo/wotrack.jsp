...
<head>
	...
	<script type="text/javascript">
		function mapLocationLookup(){			
			...
			map.setSidebar('/pluspwo/map/sidebar_location.htm');
			...
			ds.setCallout('/pluspwo/map/callout_location.htm')
			ds.setLatLngFields('LATITUDEY', 'LONGITUDEX');
			ds.addEventListener('onBoundsChanged', function(bounds){
				return '/pluspwo/ws/locationlookup.action?' + $.param(bounds);
			});
		...
		function mapAssetLookup(){			
			...
			var map = new emm.maps.Map();
			map.setProvider(emm.maps.Providers.GOOGLE);
			map.setSidebar('/pluspwo/map/sidebar_asset.htm');			
			map.addEventListener('onDataSelected', function(data){
			...
			ds.setCallout('/pluspwo/map/callout_asset.htm')
			ds.setLatLngFields('LATITUDEY', 'LONGITUDEX');
			ds.addEventListener('onBoundsChanged', function(bounds){
				return '/pluspwo/ws/assetlookup.action?' + $.param(bounds);
			});
			...
			<script type="text/javascript">
				...
				function getBounceOfflineUrl() {
					...
					return EMMServer.DB.Select()
						...
						.getUrl("offline/pluspwo/wotrack.htm");
				}			
							...
							<li>
								<span>
									...
									<s:if test="getString('HAZARDDESCRIPTION_LONGDESCRIPTION') neq ''">
										<br />
										<p class="ui-wrap"><s:property value="getString('HAZARDDESCRIPTION_LONGDESCRIPTION')" escape="false"/></p>
									</s:if>									
											...
											<li>
												<span>
													...
													<s:if test="getString('DESCRIPTION_LONGDESCRIPTION') neq ''">
														<br />
														<p class="ui-wrap"><s:property value="getString('DESCRIPTION_LONGDESCRIPTION')" escape="false"/></p>
													</s:if>
												</span>
											</li>										
										</s:iterator>
											...
											<li>
												<span>
													...
													<s:if test="getString('TAGOUTDESCRIPTION_LONGDESCRIPTION') neq ''">
														<br />
														<p class="ui-wrap"><s:property value="getString('TAGOUTDESCRIPTION_LONGDESCRIPTION')" escape="false"/></p>
													</s:if>
															...
															<li>
																<span>
																	...
																	<s:if test="getString('DEVICEDESCRIPTION_LONGDESCRIPTION') neq ''">
																		<br />
																		<p class="ui-wrap"><s:property value="getString('DEVICEDESCRIPTION_LONGDESCRIPTION')" escape="false"/></p>
																	</s:if>
