...
<body>
		...
		<div class="ui-container">
			...
			<div class="ui-content">
				<div class="ui-btn-container">
					<a class="ui-btn-a" onclick="emm.core.lookup(this)" data-field="CLASSSTRUCTUREID" data-source="CLASSSTRUCTUREID" data-display="CLASSIFICATIONID,CLASSIFICATIONDESC" data-search="CLASSIFICATIONID"><s:text name="global.lookup"/></a> 
				</div>
				<div class="ui-btn-container">
	...
	<div class="ui-page ui-inset">
		...
		<div class="ui-content">
			...
			<s:if test="mbo.getString('CLASSSTRUCTURE.DESCRIPTION_CLASS') != null ">
				<div class="ui-btn-container">
					<a class="ui-btn-a" href="addattribute.action"><s:text name="global.newrow"/></a>
				</div>	
			</s:if>			
		</div>
	</div>
