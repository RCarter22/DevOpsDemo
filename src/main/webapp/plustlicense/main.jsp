...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<h3 class="ui-title"><s:text name="plustasset.licenses"/></h3>
			...
			<s:if test="mboList.size > 0">
				<ul class="ui-listview">							
					...
					<s:iterator value="mboList">
						<li>
							<a>	
								<p><strong><s:property value="getString('LICENSENUM')"/></strong></p>
								...
								<p><s:property value="getMboValueInfoStatic('ENDDATE').getTitle()"/>: <s:property value="getString('ENDDATE')"/></p>
							</a>
