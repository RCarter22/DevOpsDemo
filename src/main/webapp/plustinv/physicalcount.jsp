...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<a class="ui-btn-right <s:if test="mboInvbList.get(0).getThisMboSet().toBeSaved() eq true">ui-btn-c</s:if>" onclick="emm.core.save('savephysicalcount.action?storeroom=<s:property value='storeroom'/>&itemnum=<s:property value='itemnum'/>')"><s:text name="global.save"/></a>
		</div>
					...
					<ul class="ui-listview">
						...
						<li class="ui-field">
							...
							<input type="text"
								...
								value="<s:property value="getString('ADJUSTEDPHYSCNTDATE')"/>"
								onchange="emm.core.setListValue(this)"
								data-mbo="INVBALANCESMBOSET"
