		...
		<div class="ui-content">
			...
			<ul class="ui-listview">
				...
				<li class="ui-field">
					...
					<s:textfield id="INSTALLDATE" readonly="mbo.getMboValueData('INSTALLDATE').isReadOnly()" value="%{mbo.getString('INSTALLDATE')}" onchange="emm.core.setValue(this)" />
				...
				<li class="ui-field">
					...
					<s:textfield id="STATUSDATE" readonly="mbo.getMboValueData('STATUSDATE').isReadOnly()" value="%{mbo.getString('STATUSDATE')}" onchange="emm.core.setValue(this)" />
