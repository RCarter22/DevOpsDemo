...
angular.module("ui.checkbox", []).directive("checkbox", function() {
    return {
        ...
        restrict: "E",
        replace: "true",
        template: "<button type=\"button\" ng-style=\"stylebtn\" class=\"btn\" ng-class=\"{'btn-xs': size==='default', 'btn-sm': size==='large', 'btn-lg': size==='largest', 'btn-primary': checked===true, 'btn-secondary': checked===false}\">" +
