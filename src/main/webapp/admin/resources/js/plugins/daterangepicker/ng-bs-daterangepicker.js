				...
				link: function($scope, $element, $attributes, ngModel) {
					...
					$scope.$watch(function() {
						...
						if (!$element.data('daterangepicker')){
							options.startDate = moment(ngModel.$modelValue.startDate).toDate();
							options.endDate = moment(ngModel.$modelValue.endDate).toDate();
						...
						$daterangepicker.setStartDate($scope.search.dateRange.startDate);
						$daterangepicker.setEndDate($scope.search.dateRange.endDate);
					});
