...
.directive('c3Simple', ['c3SimpleService', function(c3SimpleService) {
    return {
      ...
      controller: function($scope, $element) {
        ...
        $scope.$watch('config.data.columns + config.data.rows', function(newSeries, oldSeries) {
          ...
          // Save to element for use later
          $element.data('c3-simple', c3SimpleService[$scope.config.bindto]);
