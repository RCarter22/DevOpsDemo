					...
					<s:iterator value="mboList">
						<li>
							<a href="view.action?id=<s:property value="getUniqueIDValue()" />">
								...
								<p><s:property value="getMboValueInfoStatic('ITEMQTY').getTitle()" />: <s:property value="getString('ITEMQTY')"/></p>
								<p><s:property value="getMboValueInfoStatic('LINECOST').getTitle()" />: <s:property value="getString('LINECOST')"/></p>
