...
<body>
	<div class="ui-page ui-inset">
		<div class="ui-header">
			...
			<h3 class="ui-title"><s:text name="wotrack.plannedmaterials"/></h3>
			...
			<ul class="ui-listview">
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="LOCATION" data-source="LOCATION" data-display="LOCATION,DESCRIPTION,TYPE,SITEID" data-search="LOCATION,DESCRIPTION,TYPE,SITEID"></a>
				</li>
				<li class="ui-field">
					<label><s:property value="mbo.getMboValueInfoStatic('STORELOCSITE').getTitle()" /></label>
					<input type="text"
							id="STORELOCSITE" 
							required="<s:property value="mbo.getMboValueData('STORELOCSITE').isRequired()"/>"
							readonly="<s:property value="mbo.getMboValueData('STORELOCSITE').isReadOnly()"/>"
							value="<s:property value="mbo.getString('STORELOCSITE')"/>"
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="STORELOCSITE" data-source="LOCATION" data-display="LOCATION,DESCRIPTION,TYPE,SITEID" data-search="LOCATION,DESCRIPTION,TYPE,SITEID"></a>
				</li>				
				<li class="ui-field">
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="ORDERUNIT" data-source="MEASUREUNITID" data-display="MEASUREUNITID,ABBREVIATION,DESCRIPTION,SITEID" data-search="MEASUREUNITID,ABBREVIATION,DESCRIPTION,SITEID"></a>
				</li>				
				<li class="ui-field">
