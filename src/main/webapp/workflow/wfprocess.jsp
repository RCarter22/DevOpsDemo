...
<body>
	<div class="ui-page ui-inset">	
		...
		<s:form action="dowfaction.action" method="post">
				...
				<ul class="ui-listview ui-radiobutton">	
					<s:iterator value="mboList" status="status">
						<li>
						    ...
						    <input type="radio" id="check<s:property value="#status.index"/>" name="newStatus" value="<s:property value="getBoolean('ISPOSITIVE')"/>" <s:if test="#status.index eq 0">checked="true"</s:if>>
						</li>
					</s:iterator>
				</ul>
