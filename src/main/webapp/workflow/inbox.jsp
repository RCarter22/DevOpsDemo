...
<body>
	<div class="ui-page" data-rememberscroll="true">
		...
		<div class="ui-header">
			...
			<h3 class="ui-title"><s:text name="workflow.inboxassignments"/></h3>
			...
			<s:if test="mboList.size > 0">
			    <ul class="ui-listview">
					...
					<s:iterator value="mboList">
						<li>
							<a href="../<s:property value="getString('APP').toLowerCase()"/>/view.action?id=<s:property value="getLong('OWNERID')"/>">
								<p><strong><s:property value="getMboValueInfoStatic('DUEDATE').getTitle()"/>: <s:property value="getString('DUEDATE')"/></strong></p>								
