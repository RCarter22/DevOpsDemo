...
(function($) {
    ...
    $.jqplot.BarRenderer.prototype.init = function(options, plot) {
        ...
        this.groups = 1;
        // prop: manualBarColor
        // true to color each bar separately rather than
        // have every bar the same color.
        // Used for single series and user should
        // specify a separate 'seriesColors' array for bar.
        // Otherwise, each series will set their bars to the same color array.
        // This option has no Effect for stacked bar charts and is disabled.
        this.manualBarColor = false;
        // prop: varyBarColor
            ...
            if (this.barDirection == 'vertical') {
                for (var i=0; i<gridData.length; i++) {
                    ...
                    if ((this.fillToZero && this._plotData[i][1] < 0) || (this.waterfall && this._data[i][1] < 0)) {
                    	...
                    	if (this.manualBarColor){
                    		opts.fillStyle = positiveColors.next();
                    	}
                    	else if (this.varyBarColor && !this._stack) {
                            opts.fillStyle = positiveColors.next();
                        }
                        else {
