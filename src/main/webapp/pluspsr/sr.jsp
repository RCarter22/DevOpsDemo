...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<a class="ui-btn-right <s:if test="mbo.toBeSaved() eq true">ui-btn-c</s:if>" onclick="emm.core.save();prepareBounce();"><s:text name="global.save"/></a>
			...
			<ul class="ui-listview">
				...
				<s:if test="!mbo.isNew()">
					...
					<li class="ui-field">
						...
						<s:textfield readonly="true" value="%{mbo.getString('PERSON.PRIMARYPHONE')}" />
					...
					<li class="ui-field">
						...
						<s:textfield readonly="true" value="%{mbo.getString('PERSON.PRIMARYEMAIL')}" />
