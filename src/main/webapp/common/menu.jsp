	...
	var html = '', 
		...
		// List of EZMaxMobile supported apps, title and icon
	 	supportedApps = [						
						...
						['PLUSTASSET','<s:text name="Assets (Tr)"/>','emm-asset'],
						 ...
						 ['PLUSTINV','<s:text name="Inventory (Tr)"/>','emm-inventory'],
						 ...
						 ['PLUSTWO','<s:text name="Work Order Tracking (Tr)"/>','emm-workorder'],
		         		['SR','<s:text name="ezmaxmobile.sr"/>','emm-service-request'],
						 ['LABREP','<s:text name="ezmaxmobile.labrep"/>','emm-labor'],
						 ['PLUSTLRP','<s:text name="Labor Reporting (Tr)"/>','emm-labor'],        		
