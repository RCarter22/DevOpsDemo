	...
	var html = '', 
		...
		// List of EZMaxMobile supported apps, title and icon
	 	supportedApps = [						
						...
						['PLUSTASSET','<s:text name="ezmaxmobile.asset"/>','emm-asset'],
						 ...
						 ['PLUSTINV','<s:text name="ezmaxmobile.inventor"/>','emm-inventory'],
						 ...
						 ['PLUSTWO','<s:text name="ezmaxmobile.wotrack"/>','emm-workorder'],
		         		['SR','<s:text name="ezmaxmobile.sr"/>','emm-service-request'],
						 ['LABREP','<s:text name="ezmaxmobile.labrep"/>','emm-labor'],
						 ['PLUSTLRP','<s:text name="ezmaxmobile.labrep"/>','emm-labor'],        		
