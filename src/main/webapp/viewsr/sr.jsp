		...
		<div class="ui-content">
			...
			<ul class="ui-listview ui-inset" data-visible="<s:property value='!mbo.isNew()'/>">
				<li class="ui-pagination">	
					<a class="ui-pagination-prev" href="#" onclick="emm.core.movePrev('prevsr.action?id=<s:property value="mbo.getUniqueIDValue()"/>')">	
					...
					<a class="ui-pagination-next" href="#" onclick="emm.core.moveNext('nextsr.action?id=<s:property value="mbo.getUniqueIDValue()"/>')">	
						<span class="ui-arrow"></span>							
					</a>
				</li>
			</ul>	
			...
			<ul class="ui-listview">
				...
				<li class="ui-field-block">
					...
					<textarea
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('DESCRIPTION').isReadOnly()"/>"
				...
				<li class="ui-field-block">
					...
					<textarea
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('DESCRIPTION_LONGDESCRIPTION').isReadOnly()"/>"
							onchange="emm.core.setValue(this)"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('REPORTEDBYID').isReadOnly()"/>"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('REPORTEDEMAIL').isReadOnly()"/>"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('AFFECTEDPERSONID').isReadOnly()"/>"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('LOCATION').isReadOnly()"/>"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('ASSETNUM').isReadOnly()"/>"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('REPORTEDPRIORITY').isReadOnly()"/>"
				...
				<li class="ui-field">
					...
					<input type="text"
							...
							readonly="<s:property value="!mbo.isNew() || mbo.getMboValueData('GLACCOUNT').isReadOnly()"/>"
