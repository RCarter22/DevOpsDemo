...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<a class="ui-btn-right <s:if test="mbo.toBeSaved() eq true">ui-btn-c</s:if>" href="doissuecurrentitem.action"><span class="emm-floppy-o"></span></a>
			...
			<ul class="ui-listview">
			    ...
			    <li class="ui-field">
					...
					<input type="text"
							...
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-arrow" onclick="emm.core.lookup(this)" data-field="ASSETNUM" data-source="ASSETNUM" data-display="ASSETNUM,DESCRIPTION,ORGID" data-search="ASSETNUM,DESCRIPTION"></a>
				</li>
			    <li class="ui-field">
			    ...
			    <li class="ui-field">
					...
					<input type="text"
							...
							value="<s:property value="mbo.getDate('ACTUALDATE').getTime()"/>"
							onchange="emm.core.setValue(this)"
					/>
					<a class="ui-datepicker" data-control="datepicker" data-datetype="datetime" data-input="ACTUALDATE"></a>
				</li>
			    <li class="ui-field">
