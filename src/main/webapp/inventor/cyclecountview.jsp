...
<body>
	<div class="ui-page ui-inset">
		...
		<div class="ui-header">
			...
			<a class="ui-btn-right <s:if test="mbo.toBeSaved() eq true">ui-btn-c</s:if>" onclick="emm.core.save('cyclecountsave.action?storeroom=<s:property value='storeroom'/>')"><span class="emm-floppy-o"></span></a>
