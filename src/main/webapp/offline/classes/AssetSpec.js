...
function AssetSpec (){
    ...
    this.setUniqueIdentifier('ASSETSPECID');

   
};

AssetSpec.prototype.createNew = function(obj){	
	this.ISACTIVE = '1';
...
AssetSpec.prototype.lookup = function(attr, options){
	var self = this;
	var attributes = {
...
/* Is Required*/
AssetSpec.prototype.isRequired = function(attr){
    var self = this;
    var attributes = {
    	NUMVALUE: function(){
    		if (self.MANDATORY == "1")
...
AssetSpec.prototype.validate = function(){
