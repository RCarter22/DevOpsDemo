function TicketSpec (){
    ...
    this.setUniqueIdentifier('TICKETSPECID');

   
};

TicketSpec.prototype.createNew = function(obj){	
...
TicketSpec.prototype.lookup = function(attr, options){
	var self = this;
	var attributes = {
...
/* Is Required*/
TicketSpec.prototype.isRequired = function(attr){
    var self = this;
    var attributes = {
    	NUMVALUE: function(){
    		if (self.MANDATORY == "1")
...
TicketSpec.prototype.validate = function(){
